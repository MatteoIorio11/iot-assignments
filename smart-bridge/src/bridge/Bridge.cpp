...
/// @brief Init of the two systems : Smart-Light-System and WasterFlow-Control-System
void Bridge::init(){
...
/// @brief At every tick we procede by executing the Tick of the WaterFlow-Control-System
void Bridge::tick(){
    tickWCS();
}
